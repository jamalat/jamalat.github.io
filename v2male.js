define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
 	...
 	API.addCurrent({
        ...
        instructions: {
            inst_welcome : `  <p> خلال البحث يطلب منكم قراءه وتخيل 70 جمله  </p></br>
                            <p>  بعد القراءه الرجاء تخيل انفسكم بالوضع الموصوف في كل جمله وبعد ذلك الضغط على الفراغ في لوحة المفاتيح </p></br>
    ...
    API.addStimulusSets({
	    ...
	    Q7          : [{inherit:'defaultStim', media: '  حدد من 1 حتى 9 كم كان الوضع الموصوف في الجملة ذو صلة بطموحاتك ؟1 غير مرتبط بتاتا9 مرتبط جدا  '}],
        Q8          : [{inherit:'defaultStim', media: '  حدد من 1 حتى 9 كم كان الوضع الموصوف في الجملة ذو صلة باحتياجاتك ؟1 غير مرتبط بتاتا9 مرتبط جدا  '}], 
	    Q9          : [{inherit:'defaultStim', media: ' حدد من 1 حتى 9 كم كان الوضع الموصوف في الجملة ذو صلة بمخاوفك؟1 غير مرتبط بتاتا9مرتبط جدا  '}]   
     ...
     ***********************************************/
	    ...
	    API.addTrialSet('scripts', [
	        {inherit: 'stimulus_trial', data: {text: 'أقوم بالسباحه في البحيره مغمض العينين واسمع  حفيف الأشجار  ', sid: 60}},
	        {inherit: 'stimulus_trial', data: {text: ' انا اجلس مع حبيبتي امام المدفئه ونحتسي الشوكولا الساخنه ', sid: 61}},
	        {inherit: 'stimulus_trial', data: {text: 'انا جالس في السينما وبجانبي حبيبتي تحاول التودد الي ', sid: 62}},
		...
		{inherit: 'stimulus_trial', data: {text: '  بعد علاقه غراميه دامت لسنوات تقوم بالانفصال عني  ', sid: 107}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'بعد ان تحدثت بالعربيه بالقطار  شابة بجانبي تغير مكانه  ', sid: 118}},
	        {inherit: 'stimulus_trial', data: {text: 'انا اشهد  تلقي عجوز اجابة عدم الاصابه بفيروس الكورونا     ', sid: 48}},
	        {inherit: 'stimulus_trial', data: {text: 'ألموظفون اليهود معي في العمل يتقاضون اجرا اكثر مني    ', sid: 119}},
	        {inherit: 'stimulus_trial', data: {text: 'لا يشركونني ببرنامج للمواهب بادعائهم ان العرب غير موهوبين ', sid: 120}},
	        {inherit: 'stimulus_trial', data: {text: '      اتبرع بالمال  لدار الايتام لكن المسؤولين عن الميتم يسرقونه   ', sid: 129}},
		...
		{inherit: 'stimulus_trial', data: {text: 'انا أرى من النافذه وصول الباص للمحطه ونزول الركاب ', sid: 164}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: ' انا امشي بالمدينه ليلا ولا استطيع ايجاد طريق الرجوع    ', sid: 222}},
