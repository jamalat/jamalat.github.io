define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
    ...
    API.addStimulusSets({
	    ...
	    Q9          : [{inherit:'defaultStim', media: ' حدد من 1 حتى 9 كم كان الوضع الموصوف في الجمله ذو صلة بمخاوفك؟1 غير مرتبط بتاتا9مرتبط جدا  '}]   
     ...
     ***********************************************/
		...
		{inherit: 'stimulus_trial', data: {text: 'بينما انا  غاضب جدا  اكتشف قدرتي  على التحكم بالنار   ', sid:280}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: ' انا رجل مقتدر ماديا لذلك اتبرع شهريا بالمال للطلاب ', sid: 40}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'انا وصديقي في طريقنا ذاهبون للمساهمه في التبرع بالدم  ', sid: 54}},
		...
		{inherit: 'stimulus_trial', data: {text: 'اختي تخلع الحجاب مما يتسبب بصراعات بينها وبين اهلي ', sid: 92}},
	        {inherit: 'stimulus_trial', data: {text: 'والداي يجبرونني على الصلاة  لكني لا استطيع ان ارفض  ', sid: 137}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'امي لديها الزهايمر واحيانا اضطر لتذكيرها بكيفية تناول الطعام    ', sid: 103}},
	        {inherit: 'stimulus_trial', data: {text: 'صديقي يطلب مني ان اعتني له بطفله بعد وفاته   ', sid: 113}},
	        {inherit: 'stimulus_trial', data: {text: 'بينما أنظف رفي اسقط ذكرى جدي المتوفى لي واكسرها   ', sid: 114}},
		...
		{inherit: 'stimulus_trial', data: {text: 'انا انحني لكي أقوم بربط رباط حذائي بعد ان فك ', sid: 199}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: ' انا اتفقد الساعه في هاتفي واقوم بارجاعها لجيبي مجددا   ', sid: 205}},
