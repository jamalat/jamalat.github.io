define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
    ...
    API.addStimulusSets({
	    ...
	    Q7          : [{inherit:'defaultStim', media: '  حددي من 1 حتى 9 كم كان الوضع الموصوف في الجملة مرتبط بطموحاتكي ؟1 غير مرتبط بتاتا9 مرتبط جدا  '}],
        Q8          : [{inherit:'defaultStim', media: '  حددي من 1 حتى 9 كم كان الوضع الموصوف في الجملة مرتبط باحتياجاتكي ؟1 غير مرتبط بتاتا9 مرتبط جدا  '}], 
	    Q9          : [{inherit:'defaultStim', media: ' حددي من 1 حتى 9 كم كان الوضع الموصوف في الجملة مرتبط بمخاوفكي؟1 غير مرتبط بتاتا9مرتبط جدا  '}]   
