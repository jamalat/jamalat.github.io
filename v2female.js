define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
 	...
 	API.addCurrent({
        ...
        instructions: {
            inst_welcome : `<p> خلال البحث يطلب منكم قراءه وتخيل 70 جمله  </p></br>
                            ...
                            <p> ا اضغط على الفراغ  في لوحة المفاتيح للبدا بالبحث</p>`,
          

            inst_bye     : ` 
                            <p> الان يجب عليك الاجابة على بعض الأسئلة  حول التجربة</p>
    ...
    API.addStimulusSets({
	    ...
	    Q9          : [{inherit:'defaultStim', media: ' حددي من 1 حتى 9 كم كان الوضع الموصوف في الجملة مرتبط بمخاوفكي؟1 غير مرتبط بتاتا9 مرتبط جدا  '}]   
