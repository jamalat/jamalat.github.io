define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
 	...
 	API.addCurrent({
        ...
        instructions: {
            inst_welcome : `<p> خلال البحث يطلب منكم قراءه وتخيل 70 جمله  </p></br>
                            ...
                            <p> ا اضغط على الفراغ  في لوحة المفاتيح(او مسافه في الهاتف الذكي)للبدا بالبحث</p>`,
          

            inst_bye     : `<p>انتهت التجربة </p> 
                            <p>سنكون ممتنين لو أجبت على بعض الأسئلة  حول التجربة</p>
    ...
    API.addStimulusSets({
        ...
        Q1          : [{inherit:'defaultStim', media: 'حددي ما  نوع الشعور الذي اتاكي من  الجملة عندما تخيلتي الوضع الموصوف ؟اذا كان إيجابي اضغطي   1 واذا كان حيادي اضغطي 2 واذا سلبي اضغطي  3'}],
        Q2          : [{inherit:'defaultStim', media: 'حددي من 1 حتى 9 ما  شدة هذا الشعور ؟1 بلا شعور 9 شعور قوي جدا   '}],    
	    Q3          : [{inherit:'defaultStim', media: 'حددي من 1 حتى 9 ما هو احتمال حصول ما ذكر بالجملة لكي ؟1 لا يوجد احتمال 9 احتمال قوي جدا  '}],
        Q4          : [{inherit:'defaultStim', media: 'حددي من 1 حتى 9 ما مدى سرعة قفز الوضع الموصوف الى مخيلتكي فور قراءتها ؟1 بطئ جدا 9 سريع جدا '}],      
	    Q5          : [{inherit:'defaultStim', media: 'حددي من 1 حتى 9 مدى كون الوضع الموصوف في الجملة حي ومفصل  ؟1 ليس حي ولا مفصل 9 حي ومفصل جدا '}],
        Q6          : [{inherit:'defaultStim', media: 'حددي من 1 حتى 9 كم استهلكتي من جهد حتى تتوقفي عن التفكير بالوضع الموصوف بالجملة  ؟1 بلا جهد 9  جهد كبير  '}],    
	    Q7          : [{inherit:'defaultStim', media: '  حددي من 1 حتى 9 كم كان الوضع الموصوف في الجملة ذو صلة بطموحاتكي ؟1 غير مرتبط بتاتا9 مرتبط جدا  '}],
        Q8          : [{inherit:'defaultStim', media: '  حددي من 1 حتى 9 كم كان الوضع الموصوف في الجملة ذو صلة باحتياجاتكي ؟1 غير مرتبط بتاتا9 مرتبط جدا  '}], 
	    Q9          : [{inherit:'defaultStim', media: ' حددي من 1 حتى 9 كم كان الوضع الموصوف في الجملة ذو صلة بمخاوفكي؟1 غير مرتبط بتاتا9مرتبط جدا  '}]   
     ...
     ***********************************************/
	    ...
	    API.addTrialSet('scripts', [
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'انا اجلس في السينما وبجانبي حبيبي يحاول التودد الي ', sid: 62}},
		...
		{inherit: 'stimulus_trial', data: {text: 'يقومون باخباري بتلقيي جائزه عقب اكتشافي لعلاج لمرض السرطان     ', sid: 47}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'اقوم بكتابه اخر سطر من الكتاب المؤلف عن حياتي    ', sid: 59}},
	        {inherit: 'stimulus_trial', data: {text: 'بعد ان عملت على الوظيفه شهرا اتلقى علامة سقوط ', sid: 76}},
	        {inherit: 'stimulus_trial', data: {text: ' انا اجر امي على كرسي متحرك  بعد حادثه تسببتها    ', sid: 85}},
		...
		{inherit: 'stimulus_trial', data: {text: '  بعد علاقه غراميه دامت لسنوات يقوم بالانفصال عني  ', sid: 107}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'بعد ان تحدثت بالعربيه بالقطار  شاب يهودي يغير مكانه  ', sid: 118}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: '      اتبرع بالمال  لدار الايتام لكن المسؤلين عن الميتم يسرقونه   ', sid: 129}},
	        {inherit: 'stimulus_trial', data: {text: '  خسرت جميع نقودي في مشروع كنت قد استثمرت فيه  ', sid: 130}},
	        {inherit: 'stimulus_trial', data: {text: '   اليوم الموعد الأخير لدفع قسط التعليم و ليس بحوزتي المال  ', sid: 131}},
		...
		{inherit: 'stimulus_trial', data: {text: 'انا أحاول الهرب راكضا لكني لا استطيع تحريك قدماي      ', sid: 223}},
