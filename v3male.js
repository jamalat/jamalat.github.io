define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
 	...
 	API.addCurrent({
        ...
        instructions: {
            inst_welcome : `<p> خلال البحث يطلب منكم قراءه وتخيل 70 جمله  </p></br>
                            <p> بعد القراءه الرجاء التخيل انفسكم بالوضع الموصوف في كل جمله وبعد ذلك الضغط على الفراغ </p></br>
    ...
    API.addStimulusSets({
	    ...
	    Q7          : [{inherit:'defaultStim', media: '  حدد من 1 حتى 9 كم كان الوضع الموصوف في الجمله ذو صلة بطموحاتك ؟1 غير مرتبط بتاتا9  مرتبط جدا  '}],
        Q8          : [{inherit:'defaultStim', media: '  حدد من 1 حتى 9 كم كان الوضع الموصوف في الجمله ذو صلة باحتياجاتك ؟1 غير مرتبط بتاتا9  مرتبط جدا  '}], 
	    Q9          : [{inherit:'defaultStim', media: ' حدد من 1 حتى 9 كم كان الوضع الموصوف في الجمله ذو صلة بمخاوفك؟1 غير مرتبط بتاتا 9 مرتبط جدا  '}]   
     ...
     ***********************************************/
	    ...
	    API.addTrialSet('scripts', [
	        ...
	        {inherit: 'stimulus_trial', data: {text: ' والداي يبدون موافقتهم  على زواجي من المراه اللتي احب ', sid: 9}},
		...
		{inherit: 'stimulus_trial', data: {text: 'انا اجمع النقود لكي اسافر مع أصدقائي لرحله صيفيه   ', sid:35}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'بعد استثماري الأخير أصبحت غني وقمت بشراء مركب لي ', sid: 37}},
	        {inherit: 'stimulus_trial', data: {text: ' حصلت على ترقيه من مدير عملي وأصبحت رئيس القسم   ', sid: 38}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'انا اتمشى مع رفيقتي في موعدنا الأول ممسكي اليدين    ', sid: 63}},
	        {inherit: 'stimulus_trial', data: {text: 'انا واصدقائي نقوم بالتخييم في الصحراء تحت النجوم    ', sid: 64}},
	        {inherit: 'stimulus_trial', data: {text: 'انا ارتدي بدله جذابه والجميع  في الحفله ينظرون لي  ', sid: 65}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'بينما اسخر من محاضري هو يقف خلفي يسترق السمع  ', sid: 78}},
	        {inherit: 'stimulus_trial', data: {text: 'لا اخوض الامتحانات هذا الفصل بسبب كسر في يدي ', sid: 79}},
	        {inherit: 'stimulus_trial', data: {text: ' اعود متاخرا ليلا الى البيت وابي يقوم بالتهجم علي  ', sid: 88}},
	        {inherit: 'stimulus_trial', data: {text: ' اخي بجانبي يشرح لي باكيا مرتجفا انه مثلي الجنس   ', sid: 89}},
		{inherit: 'stimulus_trial', data: {text: 'ابي يرغمني على قبول زواج اختي من رجل خمسيني ', sid: 90}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: ' انا اسمع اصدقائي يخططون للسفر ويتفقون على عدم اخباري    ', sid: 111}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'لا يدخلونني للنادي الليلي لاعتقادهم بانني عربي وسافتعل المشاكل    ', sid: 122}},
	        {inherit: 'stimulus_trial', data: {text: '   حبيبتي تقوم بالانفصال عني لاني ضد العلاقات قبل الزواج ', sid: 123}},
		...
		{inherit: 'stimulus_trial', data: {text: 'انا اكتب على الدفتر جمل بالعربيه وارجع القلم للمقلمه ', sid: 180}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'انا اتفقد وجود أوراق فارغه صالحه للاستعمال داخل الدفتر       ', sid: 189}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: ' احاول التكلم لكن يخرج من فمي لعاب بدل كلمات     ', sid: 232}},
		{inherit: 'stimulus_trial', data: {text: ' انا اسبح لوحدي بالبحر ولا استطيع الوصول الى الشاطئ     ', sid: 233}},
	        {inherit: 'stimulus_trial', data: {text: 'لحظة اصطدامي  بفتاة سببت لها كدمه  كبيره في يدها   ', sid: 234}},
	        {inherit: 'stimulus_trial', data: {text: 'ابي وامي يقومون باخباري  انهم تبنوني عندما كنت طفل    ', sid: 235}},
	        {inherit: 'stimulus_trial', data: {text: 'أمشي في الشارع عبر عاصفة قوية وفجأة يضربني الرعد    ', sid: 236}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'أقوم بتلقي رسالة اعجاب من فتاه قد اعجبتني مطولا  ', sid: 266}},
	        {inherit: 'stimulus_trial', data: {text: '  أستيقظ في الصباح وأجد نفسي في قصر  انا مالكه  ', sid: 267}},
	        {inherit: 'stimulus_trial', data: {text: ' أشرب مشروبًا سحريًا وأشعر كيف أصبحت شابا إلى الأبد    ', sid: 268}},
