define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
    ...
    var answers     = all_answers[version_id-1];
 	...
 	API.addCurrent({
        ...
        instructions: {
            ...
            inst_bye     : `<p>انهيت تعبئة الجمل  </p> 
                            <p>الات يجب الاجابة على بعض الأسئلة المفتوحة حول التجربة</p>
    ...
    API.addStimulusSets({
        ...
        Q4          : [{inherit:'defaultStim', media: 'حدد من 1 حتى 9 ما مدى سرعة قفز الوضع الموصوف الى مخيلتك فور قراءة الجملة ؟1 بطئ جدا 9 سريع جدا '}],      
	    ...
	    Q9          : [{inherit:'defaultStim', media: ' حدد من 1 حتى 9 كم كان الوضع الموصوف في الجمله مرتبط بمخاوفك؟1 غير مرتبط بتاتا 9 مرتبط جدا  '}]   
