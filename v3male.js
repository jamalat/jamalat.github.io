  ...
  API.addSettings('logger', {
     ...
     ***********************************************/
		...
		{inherit: 'stimulus_trial', data: {text: 'انا اجمع النقود لكي اسافر مع أصدقائي لرحله صيفيه   ', sid:35}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: ' اعود متاخره ليلا الى البيت وابي يقوم بالتهجم علي  ', sid: 88}},
		...
		{inherit: 'stimulus_trial', data: {text: 'ابي يرغمني على قبول زواج اختي من رجل خمسيني ', sid: 90}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: '   حبيبتي تقوم بالاتفصال عني لاني ضد العلاقات قبل الزواج ', sid: 123}},
