define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
        ...
        instructions: {
            inst_welcome : ` <p> خلال البحث يطلب منكم قراءه وتخيل 70 جمله  </p></br>
                            ...
                            <p>الاجوبه المناسبه تضغط بواسطة الضغط على لوحة الارقام من 1-9 </p></br>
                             <p>  اضغطي على الفراغ  في لوحة المفاتيح  للبدا بالبحث</p>`,
          

            inst_bye     : ` 
                            <p>لان يجب عليك الاجابة على بعض الأسئلة  حول التجربة</p>
                            <p>للانتقال الى الاسئلة اضغط على الفراغ في لوحة المفاتيح</p>`
        },
        times: {
    ...
    API.addStimulusSets({
        ...
        Q1          : [{inherit:'defaultStim', media: 'حددي ما  نوع الشعور الذي اتاكي من  الجمله عندما تخيلتي الوضع الموصوف ؟اذا كان إيجابي اضغطي   1 اذا كان حيادي اضغطي 2 اذا سلبي اضغطي  3'}],
        ...
        Q4          : [{inherit:'defaultStim', media: 'حددي من 1 حتى 9 ما مدى سرعة قفز الوضع الموصوف الى مخيلتك فور قراءتة الجملة ؟1 بطئ جدا 9 سريع جدا '}],      
        ...
        Q8          : [{inherit:'defaultStim', media: '  حددي من 1 حتى 9 كم كان الوضع الموصوف في الحملة مرتبط باحتياجاتكي ؟1 غير مرتبط بتاتا9 مرتبط جدا  '}], 
	...
	{inherit: 'stimulus_trial', data: {text: 'بينما احفر في ساحة البيت أقوم بإيجاد مالا مدفونا  ', sid:31}},
        ...
        {inherit: 'stimulus_trial', data: {text: 'يتصلون لاخباري عن توقيف تعليمي الجامعي بسبب علاماتي الممنخفضه    ', sid: 71}},
	...
	{inherit: 'stimulus_trial', data: {text: 'يغمى علي وعند استيقاظي اكتشف انني استطيع قراءة  الأفكار   ', sid: 252}},
        {inherit: 'stimulus_trial', data: {text: '  نمت لي  أجنحة ضخمة وانا الان أطير في السماء  ', sid: 253}},
        {inherit: 'stimulus_trial', data: {text: ' يوجد معي عصا سحريه تقوم بتلبية كل  ما اريد     ', sid: 254}},
        {inherit: 'stimulus_trial', data: {text: ' انا افوز بمنافسة ملكة جمال العالم لعام الفبن وعشرين      ', sid: 281}}
    ]);
