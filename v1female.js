define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
    ...
    API.addStimulusSets({
	    ...
	    Q7          : [{inherit:'defaultStim', media: '  حددي من 1 حتى 9 كم كان الوضع الموصوف في الحمله مرتبط بطموحاتكي ؟1 غير مرتبط بتاتا9 مرتبط جدا  '}],
        Q8          : [{inherit:'defaultStim', media: '  حددي من 1 حتى 9 كم كان الوضع الموصوف في الحمله مرتبط باحتياجاتكي ؟1 غير مرتبط بتاتا9 مرتبط جدا  '}], 
	...
	{inherit: 'stimulus_trial', data: {text: 'يغمى علي وعند استيقاظي اكتشف انني استطيع قراءة  الأفكار   ', sid: 253}},
        {inherit: 'stimulus_trial', data: {text: '  نمت لي  أجنحة ضخمة وانا الان أطير في السماء  ', sid: 254}},
