define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
        ...
        instructions: {
            inst_welcome : ` <p> خلال البحث يطلب منكم قراءه وتخيل 70 جمله  </p></br>
                            ...
                            <p>الاجوبه المناسبه تضغط بواسطة الضغط على لوحة الارقام من 1-9 </p></br>
                             <p>  اضغطي على الفراغ  في لوحة المفاتيح(او مسافه في الهاتف الذكي) للبدا بالبحث</p>`,
    ...
    API.addStimulusSets({
        ...
        Q1          : [{inherit:'defaultStim', media: 'حددي ما  نوع الشعور الذي اتاكي من  الجمله عندما تخيلتي الوضع الموصوف ؟اذا كان إيجابي اضغطي   1 اذا كان حيادي اضغط 2 اذا سلبي اضغط  3'}],
        ...
        Q4          : [{inherit:'defaultStim', media: 'حددي من 1 حتى 9 ما مدى سرعة قفز الوضع الموصوف الى مخيلتك فور قراءتها ؟1 بطئ جدا 9 سريع جدا '}],      
        ...
        Q8          : [{inherit:'defaultStim', media: '  حددي من 1 حتى 9 كم كان الوضع الموصوف في الحملة ذو صلة باحتياجاتكي ؟1 غير مرتبط بتاتا9 مرتبط جدا  '}], 
