define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
 	...
 	API.addCurrent({
        ...
        instructions: {
            inst_welcome : `<p>مرحبا وشكرا على مشاركتكم في بحثنا</p></br>
                            ...
                            <p> الجمله تختفي من الشاشه وبعد ذلك يطلب منكم الاجابه على 9 اسئله </p></br>                          
                            <p>الاجوبه المناسبه تسجل بواسطة الضغط على لوحة المفاتيح </p></br>
	...
	{inherit: 'stimulus_trial', data: {text: 'بينما احفر في ساحة البيت أقوم بإيجاد مالا مدفونا  ', sid:31}},
        ...
        {inherit: 'stimulus_trial', data: {text: 'بتصلون لاخباري عن توقيف تعليمي الجامعي بسبب علاماتي الممنخفضه    ', sid: 71}},
